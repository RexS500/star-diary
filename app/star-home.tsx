...
export default function App({account}:{account:SignedInAccount}) {
    ...
    {tab === "資料分析" && <Analytics key={child.id} data={data} child={child} onRefresh={refreshAnalytics} todayKey={todayKey} isParent={role==="家長"&&account.role!=="child"} onAdjustTask={adjustTaskFromAnalytics} onHabitAction={runHabitAction}/>}
