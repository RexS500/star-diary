...
export default function App() {
    ...
    function normalizedClientState(loaded:Partial<State>):State{return {...fallback,...loaded,children:Array.isArray(loaded.children)?loaded.children:fallback.children,entries:Array.isArray(loaded.entries)?loaded.entries:[],rewards:Array.isArray(loaded.rewards)?loaded.rewards:[],templates:Array.isArray(loaded.templates)?loaded.templates:[],redemptions:Array.isArray(loaded.redemptions)?loaded.redemptions:[],specialRewards:Array.isArray(loaded.specialRewards)?loaded.specialRewards:[],rewardIconLibrary:Array.isArray(loaded.rewardIconLibrary)?loaded.rewardIconLibrary:[],dailyTasks:Array.isArray(loaded.dailyTasks)?loaded.dailyTasks:[],dailyTaskRecords:Array.isArray(loaded.dailyTaskRecords)?loaded.dailyTaskRecords:[],dailyTaskSettings:loaded.dailyTaskSettings&&typeof loaded.dailyTaskSettings==="object"?loaded.dailyTaskSettings:{},favoriteOfficialTaskIds:Array.isArray(loaded.favoriteOfficialTaskIds)?loaded.favoriteOfficialTaskIds:[],dailyTaskSortMode:loaded.dailyTaskSortMode==="custom"?"custom":"flow"}}
